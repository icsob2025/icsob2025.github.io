...
If you really do not want to tell your users to "Left click, download as, etc.", you could try something around the lines of the code below. However, I would research CORS before implementing this into your website to confirm it is secure for your use case.
